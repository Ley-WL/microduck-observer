...
“姿态与 IMU”页已预留 15 个飞特 HD-1910 舵机的信息表，按左腿 20–24、头颈与嘴 30–34、右腿 10–14 分组。单屏表格展示关节角度、电压、温度、电流、原始负载、在线状态，以及在线数量、平均电压、最高温度和故障数量汇总；协议还预留编码器、扭矩、故障和样本年龄字段。当前所有舵机均标为“未接入”，数值为 `—`，不进行总线扫描或舵机操作。15 个物理舵机与 14 个模型关节分别统计，嘴部 ID 34 单独保留。
